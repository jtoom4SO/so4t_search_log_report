'''
This Python script is a working proof of concept example of using Stack Overflow APIs for a Search Log Report. 
...
def create_session(base_url):
    ...
    s.headers['User-Agent'] = 'so4t_search_log_report/1.0 (http://your-app-url.com; your-contact@email.com)'
    driver.close()
    driver.quit()
